...
const List<Meal> meals = [
  ...
  Meal(
    ...
    time: "25",
    description:
        "A classic Indian dish made with tender chicken cooked in a rich, creamy tomato and butter sauce, flavored with a blend of aromatic spices.",
    categoryNumber: "c2",
  ),
  Meal(
    id: "m3",
    ...
    time: "25",
    description:
        "Classic Italian pasta dish made with fettuccine tossed in a rich and creamy Parmesan cheese and butter sauce.",
    categoryNumber: "c4",
  ),
  Meal(
    id: "m4",
    ...
    time: "30",
    description:
        "A premium cut of beef, grilled or pan-seared to perfection, often served with a side of vegetables or potatoes.",
    categoryNumber: "c3",
  ),
  Meal(
    id: "m5",
    ...
    time: "25",
    description:
        "Flavorful rice cooked with smoked cheese, offering a creamy texture and a rich, smoky taste.",
    categoryNumber: "c7",
  ),
  Meal(
    id: "m6",
    ...
    time: "30",
    description:
        "Aromatic and flavorful Indian rice dish made with tender lamb, fragrant basmati rice, and a blend of traditional spices.",
    categoryNumber: "c2",
  ),
  Meal(
    id: "m7",
    ...
    time: "30",
    description:
        "Grilled skewers of marinated chicken (Shish Tawook) served over a bed of seasoned rice, a popular Middle Eastern dish.",
    categoryNumber: "c7",
  ),
  Meal(
    id: "m8",
    ...
    time: "35",
    description:
        "Slow-cooked lamb shank, tender and falling off the bone, often braised in a rich sauce with vegetables and herbs.",
    categoryNumber: "c3",
  ),
];
